...
abstract class CheckinMixin {
    ...
    @JsonCreator
    CheckinMixin(@JsonProperty("id") String id, @JsonProperty("place") Page place, @JsonProperty("from") Reference from,
                 @JsonProperty("application") Reference application, @JsonProperty("created_time") Date createdTime) {
    }
